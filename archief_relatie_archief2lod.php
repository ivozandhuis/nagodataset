<?php
/**
 * Create a turtle file from the 'relations/archief_relatie_archief.csv' file
 */
...
# read csv-file
$fileToRead = __DIR__ . '/input/relations/archief_relatie_archief.csv';
...
$fileToWrite = __DIR__ . '/output/archief_relatie_archief.ttl';
