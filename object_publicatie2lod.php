<?php
/**
 * Create a turtle file from the 'relations/object_publicatie.csv' file
 */
...
# read csv-file
$fileToRead = __DIR__ . '/input/relations/object_publicatie.csv';
...
$fileToWrite = __DIR__ . '/output/object_publicatie.ttl';
...
foreach ($records as $row) {
    $objectUri = sprintf($objectBaseUri, remove_utf8_bom($row[0]));
    ...
    $graph->add($object, 'dc:relation', $pub);
}
