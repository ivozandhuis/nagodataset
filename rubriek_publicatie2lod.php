<?php
/**
 * Create a turtle file from the 'relations/rubriek_publicatie.csv' file
 */
...
# read csv-file
$fileToRead = __DIR__ . '/input/relations/rubriek_publicatie.csv';
...
$fileToWrite = __DIR__ . '/output/rubriek_publicatie.ttl';
